...
import { fetchFirstFileSizePromise, fetchSumOfFileSizesPromise } from '.';
...
describe('callback vs promise', () => {
  ...
  const cases = [
    ['fetchFirstFileSize', fetchFirstFileSizeCb, fetchFirstFileSizePromise],
    ['fetchSumOfFileSizes', fetchSumOfFileSizesCb, fetchSumOfFileSizesPromise],
  ];
